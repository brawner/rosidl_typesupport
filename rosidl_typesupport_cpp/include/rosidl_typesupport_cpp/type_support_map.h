...
typedef struct type_support_map_t
{
  ...
  /// Array of symbol names associated with each type support.
  /// These symbol names are generated by the macro,
  /// `ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME` in `rosidl_typesupport_interface`
